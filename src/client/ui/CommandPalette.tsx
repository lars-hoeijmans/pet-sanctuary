...
export function CommandPalette() {
  ...
  const artifactDrawerOpen = useWorldStore((s) => s.artifactDrawerOpen);
  ...
  const commands = useMemo<Command[]>(() => {
    ...
    const list: Command[] = [
      ...
      {
        id: "artifacts",
        label: artifactDrawerOpen ? "Collapse artifacts" : "Expand artifacts",
        run: () => { s.setArtifactDrawerOpen(!artifactDrawerOpen); close(); },
      },
    ];
    if (selectedAgentId) {
    ...
    return list;
  }, [agents, selectedAgentId, isDemoPlaying, artifactDrawerOpen, setOpen, store]);
